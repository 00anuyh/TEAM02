...
const SESSION_KEY = "souvenir_session_v1"; // { userid, name, loginAt }
...
const setSession = (userid, name) =>
  localStorage.setItem(SESSION_KEY, JSON.stringify({ userid, name, loginAt: Date.now() }));
/* ====== ⬆️ 유틸 끝 ⬆️ ====== */
